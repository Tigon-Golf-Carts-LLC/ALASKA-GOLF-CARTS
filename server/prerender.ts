...
function renderFaq(): string {
  const faqs: { q: string; a: string }[] = [
    { q: "How much do golf carts cost at Alaska Golf Carts?", a: "New golf carts start around $9,995 and pre-owned carts start around $4,500. All units are priced at wholesale MSRP with no dealer markup, and pricing updates nightly with our inventory." },
