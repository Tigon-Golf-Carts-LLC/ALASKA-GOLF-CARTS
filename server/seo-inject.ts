...
function getRouteMetaFromUrl(url: string, cartMeta?: PageMeta): PageMeta {
  ...
  if (pathname === "/" || pathname === "") {
    return {
      title: "Golf Carts for Sale — New & Used Inventory Updated Daily | Discounted Golf Carts",
      description:
  ...
  if (pathname === "/inventory") {
    if (search) {
      ...
      if (filterStr) {
        return {
          title: `${subject} for Sale | Discounted Golf Carts`,
  ...
  if (pathname === "/about") {
    return {
      title: "About Discounted Golf Carts — Serving All of Florida",
      description:
        "Discounted Golf Carts is a golf cart dealership serving all 67 counties across Florida. New and used carts from 13 brands. Inventory updated daily. Statewide delivery.",
    };
  }
  ...
  if (pathname === "/service-area") {
    return {
      ...
      description:
        "Discounted Golf Carts serves the entire state of Florida — all 67 counties, from Miami-Dade and Broward to Duval, Hillsborough, Orange, and beyond. Statewide delivery available.",
    };
  }
...
function getPageSchema(pathname: string): Record<string, unknown> | null {
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": { "@type": "Answer", "text": "New golf carts at Discounted Golf Carts start at approximately $9,995. Used golf carts typically range from $4,500 to $12,000 depending on brand, age, and condition. Call 1-888-840-4490 for current pricing." },
        },
        {
          "@type": "Question",
  ...
  if (pathname === "/service-area") {
    return {
      ...
      "description": "Discounted Golf Carts serves the entire state of Florida — all 67 counties. New and used golf carts with statewide delivery.",
  ...
  if (pathname === "/inventory") {
    return {
      ...
      "name": "Golf Cart Inventory — New & Used Golf Carts for Sale | Discounted Golf Carts",
      "isPartOf": { "@id": `${BASE_URL}/#website` },
