    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="prose prose-sm dark:prose-invert max-w-none space-y-8">
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">Discounted Golf Carts delivers statewide to all 67 Florida counties. Local pickup can also be arranged by appointment during normal business hours. Please call ahead to confirm your unit is ready and to schedule delivery or pickup.</p>
        </section>
