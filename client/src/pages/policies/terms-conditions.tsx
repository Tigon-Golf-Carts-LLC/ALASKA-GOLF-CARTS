    ...
    <div className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="prose prose-sm dark:prose-invert max-w-none space-y-8">
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">All pricing displayed on alaskagolfcarts.com reflects current MSRP and is updated nightly. Prices are subject to change without notice. Inventory availability is not guaranteed until a purchase agreement is signed and a deposit is received. Alaska Golf Carts reserves the right to correct pricing errors at any time.</p>
        </section>
