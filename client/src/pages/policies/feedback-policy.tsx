  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12">
      <SeoHead
        ...
        canonical="https://discountedgolfcart.com/feedback-policy"
      />
      ...
      <div className="prose prose-sm dark:prose-invert max-w-none space-y-8">
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">Feedback can be submitted by calling us at <a href={PHONE_TEL} className="text-primary font-semibold hover:underline">{PHONE_NUMBER}</a>, visiting any of our 14 retail locations, or leaving a review on Google. We encourage honest and detailed feedback to help us understand your experience.</p>
        </section>
