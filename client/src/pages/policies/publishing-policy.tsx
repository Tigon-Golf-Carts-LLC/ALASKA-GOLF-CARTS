  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12">
      <SeoHead
        ...
        canonical="https://discountedgolfcart.com/publishing-policy"
      />
      ...
      <div className="prose prose-sm dark:prose-invert max-w-none space-y-8">
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">All text, images, logos, and other content on discountedgolfcart.com is the property of Discounted Golf Carts / Tigon Golf Carts LLC or is used with permission. Unauthorized reproduction, distribution, or use of any content from this site is prohibited.</p>
        </section>
