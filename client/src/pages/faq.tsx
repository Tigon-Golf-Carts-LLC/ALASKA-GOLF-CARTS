...
const FAQ_SCHEMA = {
  ...
  "mainEntity": [
    ...
    },
    {
      ...
      "acceptedAnswer": {"@type": "Answer", "text": "Electric golf carts run on battery packs (36V, 48V, or 72V). They are quieter and produce no exhaust. Gas golf carts use combustion engines and are preferred where charging is inconvenient or for longer range. Both types are available at all locations."}
    },
    {
      "@type": "Question",
      "name": "Does Discounted Golf Carts deliver nationwide?",
      "acceptedAnswer": {"@type": "Answer", "text": "Yes. Nationwide delivery is available from any of the 14 dealership locations. Call 1-888-840-4490 for a delivery quote."}
    },
    {
      "@type": "Question",
      "name": "How many locations does Discounted Golf Carts have?",
      "acceptedAnswer": {"@type": "Answer", "text": "Discounted Golf Carts operates 14 retail locations across 9 states: Pennsylvania (Hatfield, Long Pond, Scranton), New Jersey (Ocean View, Bayville, Waretown, Rio Grande), Delaware (Dover), North Carolina (Raleigh), Indiana (South Bend), Virginia (Gloucester Point), Florida (Lecanto), South Carolina (Orangeburg), and Ohio (Swanton)."}
    },
    {
      "@type": "Question",
      "name": "Does Discounted Golf Carts accept trade-ins?",
      "acceptedAnswer": {"@type": "Answer", "text": "Yes. Trade-ins are accepted at all 14 locations. Call 1-888-840-4490 to get a trade-in estimate before visiting."}
    },
    {
      "@type": "Question",
...
const faqs = [
  ...
  },
  {
    ...
    a: "Electric golf carts run on battery packs (typically 36V, 48V, or 72V lithium-ion or lead-acid). They are quieter, produce no exhaust, and have lower per-mile energy costs. Gas golf carts use small combustion engines and are preferred where charging infrastructure is limited or for longer-range applications. Both types are stocked at all Discounted Golf Carts locations."
  },
  {
    q: "What is a lifted golf cart?",
    a: "A lifted golf cart has an aftermarket suspension lift kit installed, raising the vehicle's ground clearance by 3 to 6 inches. Lifted carts can accommodate larger tires and are popular for off-road use, hunting, farm, and rough terrain. Discounted Golf Carts stocks pre-lifted models at all locations."
  },
  {
    q: "Does Discounted Golf Carts deliver nationwide?",
    a: "Yes. Nationwide delivery is available from any of the 14 dealership locations. Call 1-888-840-4490 for a delivery quote to your address."
  },
  {
    q: "How many locations does Discounted Golf Carts have?",
    a: "Discounted Golf Carts operates 14 retail locations across 9 states: Pennsylvania (Hatfield, Long Pond, Scranton), New Jersey (Ocean View, Bayville, Waretown, Rio Grande), Delaware (Dover), North Carolina (Raleigh), Indiana (South Bend), Virginia (Gloucester Point), Florida (Lecanto), South Carolina (Orangeburg), and Ohio (Swanton)."
  },
  {
    q: "Does Discounted Golf Carts accept trade-ins?",
    a: "Yes. Trade-ins are accepted at all 14 locations. Call 1-888-840-4490 to get an estimated value before visiting a store."
  },
  {
  ...
  return (
    <div className="min-h-screen">
      <SeoHead
        ...
        description="Golf cart buying questions answered: how much do they cost, what brands are available, how does financing work, and what is a street-legal LSV. 14 locations, call 1-888-840-4490."
